...
export class AffiliateCreatorV202505Api {
     ...
     * @param data The local file to be uploaded. Note： - For files larger than 10 MB, use the [Large File Uploads](https://partner.tiktokshop.com/docv2/page/wfi3nz36). - Supported formats: MP4, MOV, MKV, WMV, WEBM, AVI, 3GP, FLV, MPEG - Max video size: 10 MB - Video aspect ratio: 9:16 to 16:9 Recommendations for product videos: - Resolution: 720p or higher - Duration: &gt; 30 seconds
     */
