...
export class Fbt202602PrintInboundOrderLabelsRequestBody {
    /**
    ...
    */
    ...
    /**
    * The numeric identifier of the inbound order to print labels for.   **Note:** Provide the numeric sequence only; do not include the \"IBR\" prefix (e.g., use `123456` instead of `IBR123456`).
    */
    'orderId'?: string;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return Fbt202602PrintInboundOrderLabelsRequestBody.attributeTypeMap;
    }
}
